    ...
    <div className="max-w-6xl px-6 py-10 mx-auto space-y-8">
      <div className="px-4 h-16 rounded-xl bg-zinc-900 shadow-shape flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-zinc-100">Salvado, Brasil</span> 
        </div>
      ...
      <main className="flex gap-16 px-6">
        <div className="flex-1 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <button onClick={handleOpenCreateActionModal} className="bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400">
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center justify-between">
                <div className="sapace-y-1.5">
                  ...
                  <a href="#" className="block font-xs text-zinc-400 truncate hover:text-zinc-200">https://www.notion.com/pages/1047000112354648336?</a>
                </div>
                <Link2 className="text-zinc-400 size-5 shrink-0" />
              </div>
            </div>
            ...
            <div className="space-y-5">
              <div className="flex items-center justify-between">
                  <div className="sapace-y-1.5">
                    ...
                    <span className="block font-xs text-zinc-400 truncate">jessica.white44@yahoo.com</span>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="sapace-y-1.5">
                    ...
                    <span className="block font-xs text-zinc-400 truncate">lacy.stiedemann@gmail.com</span>
                  </div>
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <form  className='space-y-3'>
              <div className='h-14 px-4 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
                ...
                <input name="title" placeholder="Qual a atividade?" className="bg-transparent text-lg place-holder-zinc-400 outline-none flex-1"/>
              </div>
    
              <div className="flex item gap-2">
                <div className='h-14 px-4 flex-1 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
                  <Calendar className='size-5 text-zinc-400' />
                  <input type="datetime-local" name="email" placeholder="20 de agosto" className="bg-transparent text-lg place-holder-zinc-400 outline-none flex-1"/>
                </div>
                <div className='h-14 px-4 w-36 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
                  <Clock className='size-5 text-zinc-400' />
                  <input type="datetime-local" name="email" placeholder="Horário" className="bg-transparent text-lg place-holder-zinc-400 outline-none flex-1"/>
                </div>
              </div>
